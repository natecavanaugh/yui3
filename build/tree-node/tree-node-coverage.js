...
_yuitest_coverage["build/tree-node/tree-node.js"].lines = {"1":0,"43":0,"44":0,"46":0,"47":0,"49":0,"50":0,"51":0,"53":0,"54":0,"55":0,"56":0,"61":0,"65":0,"66":0,"70":0,"194":0,"208":0,"209":0,"212":0,"215":0,"216":0,"217":0,"220":0,"241":0,"271":0,"282":0,"294":0,"307":0,"309":0,"310":0,"313":0,"315":0,"345":0,"357":0,"358":0,"361":0,"372":0,"384":0,"385":0,"406":0,"418":0,"419":0,"440":0,"452":0,"456":0,"457":0,"460":0,"470":0,"475":0,"476":0,"480":0,"481":0,"483":0,"484":0,"489":0,"490":0,"492":0,"493":0,"497":0,"534":0,"539":0,"543":0,"544":0,"547":0,"548":0,"552":0};
_yuitest_coverage["build/tree-node/tree-node.js"].functions = {"TreeNode:43":0,"append:193":0,"depth:207":0,"empty:240":0,"find:270":0,"hasChildren:281":0,"index:293":0,"indexOf:306":0,"insert:344":0,"isInTree:356":0,"isRoot:371":0,"next:383":0,"prepend:405":0,"previous:417":0,"remove:439":0,"size:451":0,"toJSON:469":0,"traverse:533":0,"_reindex:538":0,"(anonymous 1):1":0};
_yuitest_coverage["build/tree-node/tree-node.js"].coveredLines = 67;
_yuitest_coverage["build/tree-node/tree-node.js"].coveredFunctions = 20;
...
return this.tree.appendNode(this, node, options);
    ...
    **/
    depth: function () {
        _yuitest_coverfunc("build/tree-node/tree-node.js", "depth", 207);
_yuitest_coverline("build/tree-node/tree-node.js", 208);
if (this.isRoot()) {
            _yuitest_coverline("build/tree-node/tree-node.js", 209);
return 0;
        }

        _yuitest_coverline("build/tree-node/tree-node.js", 212);
var depth  = 0,
            parent = this.parent;

        _yuitest_coverline("build/tree-node/tree-node.js", 215);
while (parent) {
            _yuitest_coverline("build/tree-node/tree-node.js", 216);
depth += 1;
            _yuitest_coverline("build/tree-node/tree-node.js", 217);
...
return depth;
    ...
    **/
    empty: function (options) {
        _yuitest_coverfunc("build/tree-node/tree-node.js", "empty", 240);
_yuitest_coverline("build/tree-node/tree-node.js", 241);
return this.tree.emptyNode(this, options);
    ...
    **/
    find: function (options, callback, thisObj) {
        _yuitest_coverfunc("build/tree-node/tree-node.js", "find", 270);
_yuitest_coverline("build/tree-node/tree-node.js", 271);
return this.tree.findNode(this, options, callback, thisObj);
    ...
    **/
    hasChildren: function () {
        _yuitest_coverfunc("build/tree-node/tree-node.js", "hasChildren", 281);
_yuitest_coverline("build/tree-node/tree-node.js", 282);
return !!this.children.length;
    ...
    **/
    index: function () {
        _yuitest_coverfunc("build/tree-node/tree-node.js", "index", 293);
...
return this.parent ? this.parent.indexOf(this) : -1;
    ...
    **/
    indexOf: function (node) {
        _yuitest_coverfunc("build/tree-node/tree-node.js", "indexOf", 306);
_yuitest_coverline("build/tree-node/tree-node.js", 307);
var index;

        _yuitest_coverline("build/tree-node/tree-node.js", 309);
if (this._isIndexStale) {
            _yuitest_coverline("build/tree-node/tree-node.js", 310);
this._reindex();
        }

        _yuitest_coverline("build/tree-node/tree-node.js", 313);
index = this._indexMap[node.id];

        _yuitest_coverline("build/tree-node/tree-node.js", 315);
return typeof index === 'undefined' ? -1 : index;
    ...
    **/
    insert: function (node, options) {
        _yuitest_coverfunc("build/tree-node/tree-node.js", "insert", 344);
_yuitest_coverline("build/tree-node/tree-node.js", 345);
return this.tree.insertNode(this, node, options);
    ...
    **/
    isInTree: function () {
        _yuitest_coverfunc("build/tree-node/tree-node.js", "isInTree", 356);
_yuitest_coverline("build/tree-node/tree-node.js", 357);
if (this.tree && this.tree.rootNode === this) {
            _yuitest_coverline("build/tree-node/tree-node.js", 358);
return true;
        }

        _yuitest_coverline("build/tree-node/tree-node.js", 361);
return !!(this.parent && this.parent.isInTree());
    ...
    **/
    isRoot: function () {
        _yuitest_coverfunc("build/tree-node/tree-node.js", "isRoot", 371);
...
return !!(this.tree && this.tree.rootNode === this);
    ...
    **/
    next: function () {
        _yuitest_coverfunc("build/tree-node/tree-node.js", "next", 383);
...
return this.parent.children[this.index() + 1];
    ...
    **/
    prepend: function (node, options) {
        _yuitest_coverfunc("build/tree-node/tree-node.js", "prepend", 405);
_yuitest_coverline("build/tree-node/tree-node.js", 406);
return this.tree.prependNode(this, node, options);
    ...
    **/
    previous: function () {
        _yuitest_coverfunc("build/tree-node/tree-node.js", "previous", 417);
...
return this.parent.children[this.index() - 1];
    ...
    **/
    remove: function (options) {
        _yuitest_coverfunc("build/tree-node/tree-node.js", "remove", 439);
...
return this.tree.removeNode(this, options);
    ...
    **/
    size: function () {
        _yuitest_coverfunc("build/tree-node/tree-node.js", "size", 451);
_yuitest_coverline("build/tree-node/tree-node.js", 452);
var children = this.children,
            len      = children.length,
            total    = len;

        _yuitest_coverline("build/tree-node/tree-node.js", 456);
for (var i = 0; i < len; i++) {
            _yuitest_coverline("build/tree-node/tree-node.js", 457);
total += children[i].size();
        }

        _yuitest_coverline("build/tree-node/tree-node.js", 460);
return total;
    },
    ...
    **/
    toJSON: function () {
        _yuitest_coverfunc("build/tree-node/tree-node.js", "toJSON", 469);
_yuitest_coverline("build/tree-node/tree-node.js", 470);
var obj   = {},
            state = this.state,
            i, key, len;

        // Do nothing if this node is marked as destroyed.
        _yuitest_coverline("build/tree-node/tree-node.js", 475);
if (state.destroyed) {
...
return null;
        ...
        _yuitest_coverline("build/tree-node/tree-node.js", 480);
for (i = 0, len = this._serializable.length; i < len; i++) {
            _yuitest_coverline("build/tree-node/tree-node.js", 481);
key = this._serializable[i];

            _yuitest_coverline("build/tree-node/tree-node.js", 483);
if (key in this) {
...
if (this.canHaveChildren) {
            _yuitest_coverline("build/tree-node/tree-node.js", 490);
obj.children = [];

            _yuitest_coverline("build/tree-node/tree-node.js", 492);
...
return obj;
    ...
    **/
    traverse: function (options, callback, thisObj) {
        _yuitest_coverfunc("build/tree-node/tree-node.js", "traverse", 533);
_yuitest_coverline("build/tree-node/tree-node.js", 534);
return this.tree.traverseNode(this, options, callback, thisObj);
    },

    // -- Protected Methods ----------------------------------------------------
    _reindex: function () {
        _yuitest_coverfunc("build/tree-node/tree-node.js", "_reindex", 538);
_yuitest_coverline("build/tree-node/tree-node.js", 539);
var children = this.children,
            indexMap = {},
            i, len;

        _yuitest_coverline("build/tree-node/tree-node.js", 543);
for (i = 0, len = children.length; i < len; i++) {
            _yuitest_coverline("build/tree-node/tree-node.js", 544);
indexMap[children[i].id] = i;
        }

        _yuitest_coverline("build/tree-node/tree-node.js", 547);
this._indexMap     = indexMap;
        _yuitest_coverline("build/tree-node/tree-node.js", 548);
this._isIndexStale = false;
    }
};

_yuitest_coverline("build/tree-node/tree-node.js", 552);
